...
class EstudanteService {
  ...
  static _url = `${EstudanteService._host}${EstudanteService._path}`;
  ...
  login = async (user, senha) => {
    const userToken = await httpService.onPost(
      `${EstudanteService._host}/${EstudanteService.pathAuthenticate}`,
  ...
  estudanteCreated = async estudanteModel => {
    return httpService.onPost(`${EstudanteService._url}`, estudanteModel);
  };
  ...
  getAllBlocoCartao = async idEstudante => {
    return httpService.onGet(
      `${EstudanteService._host}/${EstudanteService.pathBlocoCartao}/${idEstudante}`
    );
  };
  ...
  getBlocoCartaoById = async (idEstudante, idBlocoCartao) => {
    return httpService.onGet(
      `${EstudanteService._host}/${EstudanteService.pathBlocoCartao}/${idEstudante}/${idBlocoCartao}`
    );
  };
   ...
   * }
   */
  blocoCartaoCreated = async (idEstudante, idBlocoCartao, blocoCartaoModel) => {
    httpService.onPost(
      `${EstudanteService._host}/${EstudanteService.pathBlocoCartao}/${idEstudante}/${idBlocoCartao}`,
      blocoCartaoModel
    );
   ...
   * @param idEstudante id do estudante
   * @param idBlocoCartao id do bloco-cartao
   * @param blocoCartaoModel objeto model para update de um bloco-cartao
   * @example blocoCartaoModel : {
   * 	    "nomeBloco" : "string"
   * }
   */
